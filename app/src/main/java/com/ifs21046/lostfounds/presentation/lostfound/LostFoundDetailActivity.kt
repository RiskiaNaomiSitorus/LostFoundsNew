...
import com.ifs21046.lostfounds.data.remote.response.TodoResponse
import com.ifs21046.lostfounds.data.model.LostFound
import com.ifs21046.lostfounds.data.remote.MyResult
import com.ifs21046.lostfounds.databinding.ActivityLostfoundDetailBinding
...
private val Any.todo: TodoResponse
    ...
    private fun observeGetLostFound(todoId: Int) {
        viewModel.getLostFound(todoId).observeOnce { result ->
            when (result) {
                ...
                is MyResult.Success -> {
                    showLoading(false)
                    loadTodo(result.data.todo) // Remove extra .data
                }
